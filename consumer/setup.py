...
REMOTE_MAVEN_PACKAGES = [
    ...
    ('software.amazon.kinesis', 'amazon-kinesis-client-multilang', '2.3.3'),
    ('software.amazon.kinesis', 'amazon-kinesis-client', '2.3.3'),
    ('software.amazon.awssdk', 'kinesis', '2.15.77'),
    ('software.amazon.awssdk', 'aws-cbor-protocol', '2.15.77'),
    ('com.fasterxml.jackson.dataformat', 'jackson-dataformat-cbor', '2.9.8'),
    ('software.amazon.awssdk', 'aws-json-protocol', '2.15.77'),
    ('software.amazon.awssdk', 'dynamodb', '2.15.77'),
    ('software.amazon.awssdk', 'cloudwatch', '2.15.77'),
    ('software.amazon.awssdk', 'netty-nio-client', '2.15.77'),
    ...
    ('software.amazon.awssdk', 'sts', '2.15.77'),
    ('software.amazon.awssdk', 'aws-query-protocol', '2.15.77'),
    ('software.amazon.awssdk', 'protocol-core', '2.15.77'),
    ('software.amazon.awssdk', 'profiles', '2.15.77'),
    ('software.amazon.awssdk', 'sdk-core', '2.15.77'),
    ('com.fasterxml.jackson.core', 'jackson-core', '2.9.8'),
    ('com.fasterxml.jackson.core', 'jackson-databind', '2.9.8'),
    ('software.amazon.awssdk', 'auth', '2.15.77'),
    ('software.amazon', 'flow', '1.7'),
    ('software.amazon.awssdk', 'http-client-spi', '2.15.77'),
    ('software.amazon.awssdk', 'regions', '2.15.77'),
    ('com.fasterxml.jackson.core', 'jackson-annotations', '2.9.0'),
    ('software.amazon.awssdk', 'annotations', '2.15.77'),
    ('software.amazon.awssdk', 'utils', '2.15.77'),
    ('software.amazon.awssdk', 'metrics-spi', '2.15.77'),
    ('software.amazon.awssdk', 'aws-core', '2.15.77'),
    ('software.amazon.awssdk', 'apache-client', '2.15.77'),
    ('org.apache.httpcomponents', 'httpclient', '4.5.13'),
    ('commons-codec', 'commons-codec', '1.10'),
    ('org.apache.httpcomponents', 'httpcore', '4.4.10'),
    ('software.amazon.glue','schema-registry-serde','1.0.0'),
    ('com.amazonaws', 'aws-java-sdk-core', '1.11.950'),
    ('com.amazonaws','aws-java-sdk-sts', '1.11.950'),
...
if __name__ == '__main__':
    ...
    setup(
        ...
        license='Apache-2.0',
        packages=[PACKAGE_NAME, PACKAGE_NAME + "/v2", PACKAGE_NAME + "/v3", 'app', 'samples'],
